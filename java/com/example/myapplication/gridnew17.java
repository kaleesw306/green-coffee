...
public class gridnew17 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gridlayout17);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (grid24item) {
            ...
            case R.id.menuitemgrid3: {
                Intent about = new Intent(gridnew17.this, aboutmeclass.class);
                startActivity(about);
                break;
            }
            case R.id.menuitemgrid4: {
                Intent help = new Intent(gridnew17.this, helpclass.class);
                startActivity(help);
            ...
            case R.id.menuitemgrid6: {
                Intent webint = new Intent(gridnew17.this, webintent.class);
